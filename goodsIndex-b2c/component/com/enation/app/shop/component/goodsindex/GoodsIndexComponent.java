...
public class GoodsIndexComponent implements IComponent,IComponentStartAble {
	...
	public void install() {
		...
		this.dataOperation.imported("file:com/enation/app/shop/component/goodsindex/lucene-install.xml");
	...
	private void addMenu(){
		...
		menu.setUrl("/shop/admin/goods-index/input.do");
		menu.setSorder(105);
	...
	public void unInstall() {
		...
		deleteMenu();
		this.dataOperation.imported("file:com/enation/app/shop/component/goodsindex/lucene-uninstall.xml");
