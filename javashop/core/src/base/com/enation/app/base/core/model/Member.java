...
public class Member implements java.io.Serializable {
	...
	/**
	 * 新增字段
	 * job:职业  apartment_id:所属小区  block_num:楼号
	 * @author 沈忱 2017.5.17
	 */
	private String job;
	private Integer apartment_id;
	private String apartment_name;
	private Integer apartment_parent_id;
	private String apartment_parent_name;
	private String block_num;
	private Integer is_ordinary;	//是否普通会员(0:送货员，1:会员)
	...
	public Integer getApartment_parent_id() {
		return apartment_parent_id;
	}

	public void setApartment_parent_id(Integer apartment_parent_id) {
		this.apartment_parent_id = apartment_parent_id;
	}
	
	@NotDbField
	public String getApartment_parent_name() {
		return apartment_parent_name;
	}

	public void setApartment_parent_name(String apartment_parent_name) {
		this.apartment_parent_name = apartment_parent_name;
	}
	...
	public void setBalance_frozen(double balance_frozen) {
