...
public class Order extends DynamicField implements java.io.Serializable,PayEnable {
	...
	private String is_group = "0";//是否团购 0:否 ;1:是
	
	private Double advance_charge;
	private Double rest_charge;
	...
	public Double getRest_charge() {
		return rest_charge;
	}

	public void setRest_charge(Double rest_charge) {
		this.rest_charge = rest_charge;
	}
	...
	public void setOrderprice(OrderPrice orderPrice) {
		...
		this.setDelivery_amount(orderPrice.getDeliveryFeePrice());
