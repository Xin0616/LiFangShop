...
public interface ICartManager {
	 ...
	 * @return
	 */
	public Cart getCartByGroupId(int groupId, String sessionid);
	
	/**
	 * 根据groupId和sessionId以及addon来判断购物车中是否已经存在了一个团购物品
	 * @param groupId
	 * @param sessionid
	 * @param addon
	 * @return
	 */
public Cart getCartByGroupEndDate(int groupId, String sessionid);
	
	/**
	 * 根据groupId和sessionId以及addon来判断购物车中是否已经存在了一个团购物品时间是否结束
	 * @param groupId
	 * @param sessionid
	 * @param addon
	 * @return
