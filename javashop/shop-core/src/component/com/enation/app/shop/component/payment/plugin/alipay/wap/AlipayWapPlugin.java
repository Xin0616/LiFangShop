...
//			String payment_type = "1";
			...
			//付款金额
			String price = "";
			Order orderDetail = orderManager.get(order.getOrder_id());
			if(orderDetail.getIs_group() == null || orderDetail.getIs_group().equals("0")) {
				price = new String(String.valueOf( order.getNeedPayMoney()).getBytes("ISO-8859-1"),"UTF-8");
			} else {
				if(orderDetail.getAdvance_charge() == null || orderDetail.getAdvance_charge().equals(0d)) {
					price = new String(String.valueOf(orderManager.getAdvanceCharge(order.getOrder_id())).getBytes("ISO-8859-1"),"UTF-8");
				}
				if(orderDetail.getRest_charge() == null || orderDetail.getRest_charge().equals(0d)) {
					price = new String(String.valueOf(order.getNeedPayMoney() - orderManager.getAdvanceCharge(order.getOrder_id())).getBytes("ISO-8859-1"),"UTF-8");
				}
			}
			price = "0.01";
