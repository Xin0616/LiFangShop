...
public class CartApiController extends GridController {
	 ...
	 */
	@ResponseBody  
	@RequestMapping(value="/add-group-product", produces = MediaType.APPLICATION_JSON_VALUE)
	public JsonResult addGroupProduct(Integer productId, Integer num, Integer showCartData, Integer group_id) {
		Product product = productManager.get(productId);
		return cartPublicMethod.addGroupCart(product, num, showCartData, group_id);
	}
