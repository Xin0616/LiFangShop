...
public class B2b2cMemberStatisticsController extends GridController {
	...
	@RequestMapping(value="/memberStatistics_list")
	public ModelAndView list() {
		...
		view.setViewName("/b2b2c/admin/statistics/member/memberStatistics_list");
		return view;
	}
	...
	public GridJsonResult listJson(@RequestParam(value = "start_time", required = false) String start_time, @RequestParam(value = "end_time", required = false) String end_time) {
		...
		webpage = b2b2cMemberStatisticsManager.searchApartments(map, getPage(), getPageSize(), this.getSort(), this.getOrder());
