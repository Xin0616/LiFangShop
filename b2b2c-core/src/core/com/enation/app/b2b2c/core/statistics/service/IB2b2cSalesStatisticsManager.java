...
public interface IB2b2cSalesStatisticsManager {
	 ...
	 * 2016年12月6日下午15:16
	 */
	List<Map> averMonth_Amount(Integer order_status, int year, int month, String store_id);
	 ...
	 * 2016年12月6日下午15:16
	 */
	List<Map> averYear_Amount(Integer order_status, int year, String store_id);
